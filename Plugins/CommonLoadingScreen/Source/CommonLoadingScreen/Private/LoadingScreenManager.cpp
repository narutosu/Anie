...
bool ULoadingScreenManager::CheckForAnyNeedToShowLoadingScreen()
{
	...
	// Character->GetComponents<UActorComponent>(OutComponents);
	// for (UActorComponent* TestComponent : OutComponents)
	// {
...
void ULoadingScreenManager::HideLoadingScreen()
{
	...
	else
	{
		...
		UGameplayStatics::GetPlayerCameraManager(GetGameInstance(), 0)->StartCameraFade(1.f,0.f,1.f,FLinearColor::Black);
